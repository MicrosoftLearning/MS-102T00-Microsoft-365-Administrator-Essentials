...
3. In Lynne's Outlook mailbox, monitor her Inbox for an **?????????????????????** email that was automatically sent by the Alerts notification system (**Office365Alerts@microsoft.com**). If necessary, select the **Refresh** icon to the left of the URL address. The purpose of the email is to inform her that Holly Dickson has made a Mailbox permission change. <br/>

4. Once the notification email arrives in Lynne's Inbox, open the email and review its contents. Scroll to the bottom of the email and select the **View alert details** button. This opens the **Microsoft Defender** portal in a new tab.
...
2. Monitor Lynne's Inbox for an **?????????????????????** email that was automatically sent by the Alerts notification system (**Office365Alerts@microsoft.com**). If necessary, select the **Refresh** icon to the left of the URL address. Once the email arrives in Lynne's Inbox, open the email and review its contents. Scroll to the bottom of the email and select the **View alert details** button. This opens the **Microsoft Defender** portal in a new tab.
...
1. Switch to **LON-CL1**. On **LON-CL1**, in your Edge browser, you should still be logged into Microsoft 365 as **Holly Dickson**. 
...
4. In Holly's Outlook mailbox, monitor her Inbox for an **Informational-severity alert: eDiscovery search started or exported** email that was automatically sent by the Alerts notification system. The purpose of this message is to inform Holly that an eDiscovery search was created or exported. If necessary, select the **Refresh** icon to the left of the URL address. Once the email is received, open it and review its contents, then close the message. 
